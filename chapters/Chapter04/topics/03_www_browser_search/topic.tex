...
\centering
\textbf{WWW কাজ করার flow}\\[4pt]
User $\rightarrow$ Web Browser $\rightarrow$ Request $\rightarrow$ Web Server\\
Web Server $\rightarrow$ HTML/CSS/Image Response $\rightarrow$ Browser Output
}}
\end{center}
