...
রিলেশনাল ডেটাবেজে একাধিক টেবিল আলাদা রাখা হলেও প্রয়োজন অনুযায়ী তাদের মধ্যে সম্পর্ক তৈরি করা হয়। এই সম্পর্ক তৈরি হয় সাধারণত Primary key ও Foreign key-এর মাধ্যমে।
...
Customer(CustomerID, Name) এবং Order(OrderID, CustomerID, Date) টেবিল দেখিয়ে CustomerID-এর মাধ্যমে One-to-Many relation আঁকা হবে।
\end{examplebox}

\begin{boardbox}{বোর্ড ফোকাস}
HSC পরীক্ষায় One-to-Many relation সবচেয়ে বেশি আসে। Parent table-এর Primary key child table-এ Foreign key হিসেবে ব্যবহার হয়।
\end{boardbox}
